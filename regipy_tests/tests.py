...
def test_system_apply_transaction_logs(transaction_system, transaction_log_2):
    output_path = os.path.join(mkdtemp(), 'recovered_hive.dat')
    restored_hive_path, recovered_dirty_pages_count = apply_transaction_logs(transaction_system, transaction_log_2,
                                                                             restored_hive_path=output_path)
    assert recovered_dirty_pages_count == 305
